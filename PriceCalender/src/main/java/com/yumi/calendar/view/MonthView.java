...
public class MonthView extends LinearLayout {
    ...
    public static MonthView create(ViewGroup parent, LayoutInflater inflater, @LayoutRes int resId,
    ...
    public static MonthView create(ViewGroup parent, LayoutInflater inflater, @LayoutRes int resId,
        ...
        final MonthView view = (MonthView) inflater.inflate(resId, parent, false);
    ...
    public MonthView getMonthView(LayoutInflater inflater, ViewGroup parent) {
        return (MonthView) inflater.inflate(R.layout.month, parent, false);
    }
